...
/*	public static final String ORG2_MSP = "Org2MSP";
	...
	public static final String CHANNEL_CONFIG_PATH = "network-config/channel.tx";
...
/*	public static final String ORG2_USR_ADMIN_PK = ORG2_USR_BASE_PATH + File.separator + "keystore";
	...
	public static final String USER1_USR_BASE_PATH = "crypto-config" + File.separator + "peerOrganizations" + File.separator
			+ "org1.example.com" + File.separator + "users" + File.separator + "User1@org1.example.com"
			+ File.separator + "msp";
	public static final String USER1_USR_ADMIN_PK = USER1_USR_BASE_PATH + File.separator + "keystore";
	public static final String USER1_USR_ADMIN_CERT = USER1_USR_BASE_PATH + File.separator + "admincerts";
	...
	public static final int ordererURLStartingPort = 7050;
	
	public static final String ORDERER_NAME = "orderer0.example.com";
	
	public static final String CHANNEL_NAME = "mychannel";

	public static final int peerURLStartingPort = 7051;
...
/*
	...
	public static final String CHAINCODE_1_NAME = "EnergyTrading";

	public static final String CHAINCODE_1_PATH = "github.com/EnergyTrading";
