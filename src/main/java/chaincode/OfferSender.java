...
public class OfferSender implements Runnable {
    ...
    public OfferSender(long sendingTime, ArrayList<String> urls, int round, int producerID, UserContext userContext, String energyAmount, String priceRate){
...
/*            Util.cleanUp();
            ...
            request.setFcn("submitEnergyOffer");
            ...
            for (ProposalResponse res: responses) {
                ...
                Logger.getLogger(OfferSender.class.getName()).log(Level.INFO,"Energy Offer Submitted "+Config.CHAINCODE_1_NAME + ". Status - " + status);
            }
            ...
            responseTime=System.currentTimeMillis();
            System.err.println("Round: "+round+" Producer: "+producerID+" Transaction Failed, Duration: "+ (responseTime-submissionTime));
